...
@section('page-title', 'Set your password')
...
<div class="max-w-md mx-auto">
    <div class="bg-white rounded-xl shadow-lg border border-amber-200 overflow-hidden">
        <div class="px-6 py-4 bg-amber-50 border-b border-amber-100">
            <h2 class="text-lg font-semibold text-gray-900">Change your password</h2>
            <p class="text-sm text-gray-600 mt-1">For security, you must set a new password before continuing.</p>
        </div>
        <form method="POST" action="{{ route('admin.password.force.update') }}" class="p-6 space-y-4">
            @csrf
            <div>
