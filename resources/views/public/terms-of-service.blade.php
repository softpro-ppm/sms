    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <section>
                ...
                <p>Course fees, taxes if applicable, discounts, and payment schedules are communicated at the time of enrollment. Classroom and online course fees may differ because delivery mode, support, assessment, and infrastructure costs differ. Please confirm the selected mode before payment. Fees are non-refundable unless a written refund or cancellation policy is provided for the specific course, batch, or scheme. Payment disputes must be reported within 7 days of the transaction.</p>
            </section>
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-2">7. Public Verification</h2>
                <p>Public verification pages are provided only to confirm enrollment or certificate authenticity. They must not be used to collect, copy, profile, harass, or misuse student information. We may restrict access if we detect misuse, automated scraping, or suspicious search activity.</p>
            </section>

            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-2">8. Limitation of Liability</h2>
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-2">9. Changes to Terms</h2>
            ...
            <section>
                <h2 class="text-xl font-semibold text-gray-900 mb-2">10. Contact Us</h2>
