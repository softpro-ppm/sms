...
class WhatsAppTestCommand extends Command
{
    ...
    public function handle(WhatsAppService $whatsapp)
    {
        ...
        $this->warn('Business-initiated messages require approved Meta templates. Use --template=registration_received_2 to test templates.');
        return 1;
    }
    ...
    private function getTemplateParams(string $template): array
    {
        ...
        return match ($template) {
            ...
            'registration_received_2' => ['Test Student'],
            ...
            'fully_paid', 'fully_paid_2' => ['Test Student', 'MS Office', 'MSO-1'],
            'assessment_result', 'assessment_result_2' => ['Test Student', 'MS Office', '45', '50', '90', 'Passed'],
            'certificate_issued', 'certificate_issued_2' => ['Test Student', 'MS Office', 'CERT-TEST'],
            default => [],
        };
    }
    ...
    private function getTemplateParamNames(string $template): ?array
    {
        return match ($template) {
            ...
            'registration_received_2' => ['student_name'],
            ...
            'fully_paid', 'fully_paid_2' => ['student_name', 'course_name', 'batch_name'],
            'assessment_result', 'assessment_result_2' => ['student_name', 'course_name', 'correct_answers', 'total_questions', 'percentage', 'status'],
            'certificate_issued', 'certificate_issued_2' => ['student_name', 'course_name', 'certificate_number'],
            default => null,
        };
    }
