    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <section>
                ...
                <p>Under applicable Indian data protection requirements, including the Digital Personal Data Protection Act, 2023 when in force, you may request deletion or correction of personal data from the Softpro Student Management System. This page explains how to make that request.</p>
            </section>
            ...
            <section>
                ...
                <ul class="list-disc pl-6 space-y-1 mt-2">
                    ...
                    <li>Aadhaar number where collected for a course, scheme, certificate, or compliance purpose; date of birth, gender, address</li>
            ...
            <section>
                ...
                <ul class="list-disc pl-6 space-y-1">
                    ...
                    <li>Some data may be retained where required for legal, tax, audit, certification, dispute-resolution, or institute record purposes</li>
                    <li>If full deletion is not possible, we will explain what must be retained and whether remaining profile data can be anonymized or restricted</li>
