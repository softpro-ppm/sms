...
@section('content')
    ...
    <div class="info-box" style="border-left-color: {{ $result->is_passed ? '#16a34a' : '#dc2626' }}; background: {{ $result->is_passed ? '#f0fdf4' : '#fef2f2' }};">
        <div class="info-row"><span class="info-label">Course :</span> <span class="info-value">{{ $result->enrollment?->display_course_name ?? optional($result->assessment?->course)->name ?? 'N/A' }}</span></div>
