...
// Password reset (Reception/Admin staff only)
...
Route::middleware(['auth', 'role:admin,reception,super_admin', 'password.force'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/legacy-students/import-template', [LegacyStudentController::class, 'importTemplate'])->name('legacy-students.import-template');
    Route::post('/legacy-students/import', [LegacyStudentController::class, 'importCsv'])->name('legacy-students.import');
...
Route::middleware(['auth', 'super_admin'])->prefix('admin/super')->name('admin.super.')->group(function () {
    ...
    Route::get('training-partners/{training_partner}/activity-export/csv', [TrainingPartnerController::class, 'exportActivityCsv'])->name('training-partners.activity-export.csv');
