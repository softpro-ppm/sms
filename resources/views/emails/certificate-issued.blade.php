...
@section('header')
    ...
    <p>Congratulations on completing {{ $certificate->enrollment?->display_course_name ?? $certificate->course->name ?? 'the course' }}</p>
@endsection
@section('content')
    ...
    <div class="info-box">
        <div class="info-row"><span class="info-label">Course :</span> <span class="info-value">{{ $certificate->enrollment?->display_course_name ?? $certificate->course->name }}</span></div>
