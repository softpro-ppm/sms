...
@section('title', 'Edit Training Partner')
@section('page-title', 'Edit Training Partner')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="px-6 py-4 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
            <h2 class="text-xl font-semibold">Edit {{ $trainingPartner->name }}</h2>
        ...
        <form method="POST" action="{{ route('admin.super.training-partners.update', $trainingPartner) }}" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select id="type" name="type" required class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 @error('type') border-red-500 @enderror">
                        <option value="STANDARD" {{ old('type', $trainingPartner->type) === 'STANDARD' ? 'selected' : '' }}>Standard</option>
                        <option value="HQ" {{ old('type', $trainingPartner->type) === 'HQ' ? 'selected' : '' }}>HQ</option>
                    </select>
                ...
                <div>
                    ...
                    <select id="status" name="status" required class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 @error('status') border-red-500 @enderror">
                        <option value="active" {{ old('status', $trainingPartner->status) === 'active' ? 'selected' : '' }}>Active</option>
                        <option value="pending" {{ old('status', $trainingPartner->status) === 'pending' ? 'selected' : '' }}>Pending</option>
                        <option value="suspended" {{ old('status', $trainingPartner->status) === 'suspended' ? 'selected' : '' }}>Suspended</option>
                    </select>
            ...
            <div>
                ...
                <input type="number" id="student_approval_deduction" name="student_approval_deduction" value="{{ old('student_approval_deduction', $trainingPartner->student_approval_deduction ?? 0) }}" min="0" step="0.01"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $trainingPartner->name) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="code" name="code" value="{{ old('code', $trainingPartner->code) }}" required maxlength="20"
            ...
            <div>
                ...
                <textarea id="address" name="address" rows="2" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 @error('address') border-red-500 @enderror">{{ old('address', $trainingPartner->address) }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" id="district" name="district" value="{{ old('district', $trainingPartner->district) }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                ...
                <div>
                    ...
                    <input type="text" id="mandal" name="mandal" value="{{ old('mandal', $trainingPartner->mandal) }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                    @error('mandal')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label for="city" class="block text-sm font-medium text-gray-700 mb-2">City</label>
                    <input type="text" id="city" name="city" value="{{ old('city', $trainingPartner->city) }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="state" name="state" value="{{ old('state', $trainingPartner->state) }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                    @error('state')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                </div>
                <div>
                    <label for="pincode" class="block text-sm font-medium text-gray-700 mb-2">Pincode</label>
                    <input type="text" id="pincode" name="pincode" value="{{ old('pincode', $trainingPartner->pincode) }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
            ...
            <div class="border-t pt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" id="contact_name" name="contact_name" value="{{ old('contact_name', $trainingPartner->contact_name) }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                    ...
                    <div>
                        ...
                        <input type="text" id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $trainingPartner->contact_phone) }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
                    ...
                    <div>
                        ...
                        <input type="email" id="contact_email" name="contact_email" value="{{ old('contact_email', $trainingPartner->contact_email) }}" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500">
