    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-primary-100 text-sm">Add a new course to your institute</p>
                </div>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.courses.store') }}" class="p-6 space-y-6">
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('registration_fee', 100) }}"
                                   min="0" 
                                   step="0.01"
                ...
                <div class="mt-4 p-4 bg-primary-50 rounded-lg">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-lg font-bold text-primary-900" id="total-fee-display">₹0.00</span>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">Uncheck to create an inactive course</p>
            </div>
