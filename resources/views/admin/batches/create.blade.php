        ...
        <div class="px-6 py-4 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-primary-100 text-sm">Add a new batch to a course</p>
                </div>
            </div>
        </div>

        <!-- Form -->
        <form method="POST" action="{{ route('admin.batches.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div id="course-duration-info" class="mt-2 p-3 bg-blue-50 rounded-lg hidden">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-blue-800">Course Duration: </span>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="end_date" class="block text-sm font-medium text-gray-700 mb-2">
                            ...
                            <span class="text-xs text-gray-500 ml-2">(Auto-calculated or manual)</span>
                        </label>
                        <input type="date" 
                               id="end_date" 
                               name="end_date" 
                        ...
                        <button type="button" 
                            ...
                            Auto-calculate from course duration
                        </button>
                    </div>
                </div>
                ...
                <div class="mt-4 p-4 bg-primary-50 rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <span class="text-lg font-bold text-primary-900 ml-2" id="total-duration-display">Select dates to see duration</span>
                        </div>
                        <div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">Default is 20; you can change it.</p>
                @error('max_students')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">Uncheck to create an inactive batch</p>
            </div>
